...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria/src/dnd/useClipboard.ts).
/*
...
function addGlobalEventListener<E extends Event>(event: string, fn: (event: E) => void) {
	let eventData = globalEvents.get(event);
	if (!eventData) {
		let handlers = new Set<(e: any) => void>();
