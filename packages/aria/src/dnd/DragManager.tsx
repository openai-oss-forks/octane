...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria/src/dnd/DragManager.ts).
/*
...
class DragSession {
	...
	setup(): void {
		...
		announce(this.stringFormatter.format(MESSAGES[getDragModality() as keyof typeof MESSAGES]));
	}
		...
		if (isVirtualClick(e) || this.isVirtualClick) {
			...
			let item = [...dropElements].find(
				(item) =>
					...
					nodeContains(item.activateButtonRef?.current, eventTarget),
			);
