...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria-components/src/Toast.tsx).
/*
...
import { useIsSSR } from '../upstream-exports/react-aria/SSRProvider';
...
import { useUNSAFE_PortalContext } from '../upstream-exports/react-aria/PortalProvider';
 ...
 */
const ToastRegion = /*#__PURE__*/ (forwardRef as any)(function ToastRegion<T>(
...
const ToastList = /*#__PURE__*/ (forwardRef as any)(function ToastList<T>(
 ...
 * application.
 */
const Toast = /*#__PURE__*/ (forwardRef as any)(function Toast<T>(
	props: ToastProps<T>,
	ref: ForwardedRef<HTMLDivElement>,
) {
	let state = useContext(ToastStateContext)!;
