...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria-components/src/HiddenDateInput.tsx).
/*
...
const granularityMap: Record<string, number> = { hour: 1, minute: 2, second: 3 };
						...
						if ('setSegment' in state) {
							for (let type in targetValue) {
								...
								if (dateSegments.includes(type)) {
									state.setSegment(type as DateSegmentType, (targetValue as any)[type]);
								}
								// eslint-disable-next-line max-depth
