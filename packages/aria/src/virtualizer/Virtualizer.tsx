...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria/src/virtualizer/Virtualizer.tsx).
/*
...
function renderChildren<T extends object, V>(
	...
	return views.map((view) => {
		return renderWrapper(
			...
			(childViews: ReusableView<T, V>[]) => renderChildren(view, childViews, renderWrapper),
		);
	});
}
