...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria/src/landmark/useLandmark.ts).
/*
...
function getLandmarkManager(): LandmarkManagerApi | null {
	...
	let instance = (document as any)[landmarkSymbol] as LandmarkManagerApi | undefined;
	...
	(document as any)[landmarkSymbol] = new LandmarkManager();
	document.dispatchEvent(new CustomEvent('react-aria-landmark-manager-change'));
	return (document as any)[landmarkSymbol] as LandmarkManagerApi;
}
