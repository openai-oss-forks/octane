...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-stately/src/calendar/utils.ts).
/*
...
export function alignCenter(
	...
	for (let key in duration) {
		let durationValue = (duration as Record<string, number | undefined>)[key] ?? 0;
		(halfDuration as Record<string, number | undefined>)[key] = Math.floor(durationValue / 2);
		if (
			((halfDuration as Record<string, number | undefined>)[key] ?? 0) > 0 &&
			durationValue % 2 === 0
		) {
			(halfDuration as Record<string, number>)[key]--;
		}
	}
