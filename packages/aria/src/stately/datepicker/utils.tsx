...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-stately/src/datepicker/utils.ts).
/*
...
export function getRangeValidationResult(
	...
	if (value?.end != null && value.start != null && value.end.compare(value.start) < 0) {
		...
		result = mergeValidation(result, {
			isInvalid: true,
			validationErrors: [strings.getStringForLocale('rangeReversed', getLocale()) as string],
			validationDetails: {
...
export function getFormatOptions(
	...
	let opts: Intl.DateTimeFormatOptions = keys.slice(startIdx, endIdx + 1).reduce((opts, key) => {
		(opts as Record<string, unknown>)[key] = (fieldOptions as Record<string, unknown>)[key];
		return opts;
