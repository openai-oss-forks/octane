...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-stately/src/layout/GridLayout.ts).
/*
	...
	update(invalidationContext: InvalidationContext<O>): void {
		...
		for (let row = 0; row < rows; row++) {
			...
			for (let col = 0; col < numColumns; col++) {
				...
				let node: Node<T> | undefined = skeleton || iterator.next().value;
				if (!node) {
					break;
				}
