...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-stately/src/color/useColorFieldState.ts).
/*
...
export function useColorFieldState(props: ColorFieldProps): ColorFieldState {
	...
	let increment = () => {
		let newValue = addColorValue(parsedValue ?? colorValue ?? MIN_COLOR, step);
