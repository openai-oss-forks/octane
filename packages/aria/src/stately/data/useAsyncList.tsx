...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-stately/src/data/useAsyncList.ts).
/*
...
export interface AsyncListOptions<T, C> {
	 ...
	 */
	sort?: AsyncListLoadFunction<
		T,
		C,
		AsyncListLoadOptions<T, C> & { sortDescriptor: SortDescriptor }
	>;
}
...
type ActionType =
	'success' | 'error' | 'loading' | 'loadingMore' | 'sorting' | 'update' | 'filtering';
		...
		case 'filtering':
			switch (action.type) {
				case 'success':
					...
					selectedKeys = action.selectedKeys ? new Set(action.selectedKeys) : data.selectedKeys;
					return {
						...data,
						filterText: action.filterText ?? data.filterText,
						state: 'idle',
