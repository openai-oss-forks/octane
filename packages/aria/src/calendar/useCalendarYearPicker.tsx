...
// Ported from adobe/react-spectrum@1c84a49a1faf50b571c84e00bcf9c60b22ddd03e (packages/react-aria/src/calendar/useCalendarYearPicker.ts).
/*
...
export function useCalendarYearPicker(
	...
	return {
		...
		onChange: (key) => {
			if (key != null) {
				state.setFocusedDate(years[Number(key)].date);
			}
		},
		items: years,
	};
