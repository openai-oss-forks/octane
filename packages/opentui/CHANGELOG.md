...
- 4b44b65: add an experimental OpenTUI renderer with native terminal intrinsics, hooks,
  portals, plugin slots, scheduling helpers, and an FFI-backed test harness
