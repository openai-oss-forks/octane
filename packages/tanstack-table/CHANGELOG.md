...
- 911ed1d: Update the TanStack Table adapter and neutral core to 9.2.4. Publish controlled
  state after commit, preserve zero/empty-string renderables, and provide the
  legacy migration entrypoint with native hooks and typed helpers.
...
- Updated dependencies [47c8f54]
  - octane@0.1.51
  - @octanejs/tanstack-store@0.0.45
...
- Updated dependencies [a51c8c6]
  - octane@0.1.49
  - @octanejs/tanstack-store@0.0.43
...
- Updated dependencies [d3dbd78]
  - octane@0.1.47
  - @octanejs/tanstack-store@0.0.41
...
- Updated dependencies [d7226ff]
  - octane@0.1.46
  - @octanejs/tanstack-store@0.0.40
...
- Updated dependencies [f1a7802]
  - octane@0.1.45
  - @octanejs/tanstack-store@0.0.39
...
- Updated dependencies [7535acd]
  - octane@0.1.44
  - @octanejs/tanstack-store@0.0.38
...
- Updated dependencies [939c64d]
  - octane@0.1.42
  - @octanejs/tanstack-store@0.0.36
...
- Updated dependencies [814a3c1]
  - octane@0.1.41
  - @octanejs/tanstack-store@0.0.35
...
- Updated dependencies [cc6e5ea]
  - octane@0.1.40
  - @octanejs/tanstack-store@0.0.34
...
- Updated dependencies [0fc84da]
  - octane@0.1.39
  - @octanejs/tanstack-store@0.0.33
...
- Updated dependencies [0635af6]
  - octane@0.1.38
  - @octanejs/tanstack-store@0.0.32
...
- Updated dependencies [603756a]
  - octane@0.1.37
  - @octanejs/tanstack-store@0.0.31
...
- Updated dependencies [217a0b5]
  - octane@0.1.33
  - @octanejs/tanstack-store@0.0.27
...
- Updated dependencies [cdb501c]
  - octane@0.1.32
  - @octanejs/tanstack-store@0.0.26
...
- Updated dependencies [16df26e]
  - octane@0.1.31
  - @octanejs/tanstack-store@0.0.25
...
- Updated dependencies [9fa0b47]
  - octane@0.1.30
  - @octanejs/tanstack-store@0.0.24
...
- Updated dependencies [8fb7990]
  - octane@0.1.29
  - @octanejs/tanstack-store@0.0.23
...
- Updated dependencies [48e2397]
  - octane@0.1.26
  - @octanejs/tanstack-store@0.0.20
...
- Updated dependencies [bd8bb1b]
  - octane@0.1.25
  - @octanejs/tanstack-store@0.0.19
...
- Updated dependencies [6714914]
  - octane@0.1.24
  - @octanejs/tanstack-store@0.0.18
...
- Updated dependencies [ef82ba3]
  - octane@0.1.21
  - @octanejs/tanstack-store@0.0.15
...
- Updated dependencies [62d81b8]
  - octane@0.1.20
  - @octanejs/tanstack-store@0.0.14
...
- Updated dependencies [3aada64]
  - octane@0.1.19
  - @octanejs/tanstack-store@0.0.13
...
- Updated dependencies [e6a158e]
  - octane@0.1.18
  - @octanejs/tanstack-store@0.0.12

## 0.1.14

### Patch Changes

- bd094ec: Retarget the TanStack Table binding from v8 to v9.
  ...
  - A user-supplied `onSortingChange`-style handler now _replaces_ the feature's
...
- Updated dependencies [eb69cb6]
  - octane@0.1.17
  - @octanejs/tanstack-store@0.0.11
...
- 8de4584: New binding: TanStack Table for octane. The framework-agnostic `@tanstack/table-core` is reused verbatim; the React adapter (`useReactTable`, `flexRender`) is transcribed onto octane hooks preserving upstream's useState-based wiring, with `flexRender` rendering component cells through octane's `createElement` descriptors. Differential-verified byte-identical against real @tanstack/react-table 8.21.3 on React across sorting, filtering, pagination, selection, visibility, and expanding.
