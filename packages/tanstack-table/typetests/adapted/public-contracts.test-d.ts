...
import * as Actual0 from '@octanejs/tanstack-table';
import * as Actual1 from '@octanejs/tanstack-table/flex-render';
import * as Actual2 from '@octanejs/tanstack-table/legacy';
import * as Actual3 from '@octanejs/tanstack-table/static-functions';
import * as Actual4 from '@octanejs/tanstack-table/experimental-worker-plugin';
...
type Contract_0_ReactTable = Assert<
	Equal<keyof Actual0.OctaneTable<Features, Person>, ExpectedContracts['0_ReactTable']>
>;
...
type Contract_2_LegacyReactTable = Assert<
	Equal<keyof Actual2.LegacyOctaneTable<Person>, ExpectedContracts['2_LegacyReactTable']>
>;
