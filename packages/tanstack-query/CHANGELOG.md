...
- 43d940d: Initial release: TanStack Query bindings for octane.
  ...
  works by changing the import from `@tanstack/react-query` to `@octanejs/tanstack-query`. Verified
...
- b680431: Add React Query helper exports for `queryOptions`, `infiniteQueryOptions`, `mutationOptions`, and `useSuspenseQueries`.
