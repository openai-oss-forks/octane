// The useSuspenseQueries option/result tuple types — a 1:1 port of the type
// block in @tanstack/react-query's useSuspenseQueries.ts (pure query-core
// generics, no React).
import type { UseSuspenseQueryOptions, UseSuspenseQueryResult } from './types';
import type { DefaultError, QueryFunction, ThrowOnError } from '@tanstack/query-core';
