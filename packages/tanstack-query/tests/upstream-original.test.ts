...
import { runPristineUpstreamSuite } from '../../../scripts/react-parity/tanstack-query-pristine-runtime.mjs';

// @parity-case pristine:tanstack-query-original-suite
it('runs all 404 pinned Query runtime registrations unchanged', () => {
